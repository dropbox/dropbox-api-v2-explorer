...
module Endpoints {
    ...
    const get_thumbnail_endpt = new Utils.Endpoint("files", "get_thumbnail", Utils.EndpointKind.Download,
        ...
        new Utils.SelectorParam("size", ["w32h32", "w64h64", "w128h128", "w640h480", "w1024h768"], true)
    );
    ...
    const get_shared_links_endpt = new Utils.Endpoint("sharing", "get_shared_links", Utils.EndpointKind.RPCLike,
        new Utils.TextParam("path", true)
    );
    const create_shared_link_endpt = new Utils.Endpoint("sharing", "create_shared_link", Utils.EndpointKind.RPCLike,
        new Utils.TextParam("path", false),
        new Utils.BoolParam("short_url", true),
        new Utils.SelectorParam("pending_upload", ["file", "folder"], true)
    );
    const get_shared_folder_endpt = new Utils.Endpoint("sharing", "get_shared_folder", Utils.EndpointKind.RPCLike,
        new Utils.TextParam("id", false),
        new Utils.BoolParam("include_membership", true)
    );
    const list_shared_folders_endpt = new Utils.Endpoint("sharing", "list_shared_folders", Utils.EndpointKind.RPCLike,
        new Utils.BoolParam("include_membership", true),
        new Utils.BoolParam("show_unmounted", true)
    );
