...
namespace Endpoints {
    ...
    const files_search_v2_endpt = new Utils.Endpoint("files", "search_v2",
        ...
        new Utils.StructParam("options", true, [new Utils.TextParam("path", true), new Utils.IntParam("max_results", true), new Utils.UnionParam("order_by", true, [new Utils.VoidParam("relevance"), new Utils.VoidParam("last_modified_time")]), new Utils.UnionParam("file_status", true, [new Utils.VoidParam("active"), new Utils.VoidParam("deleted")]), new Utils.BoolParam("filename_only", true), new Utils.ListParam("file_extensions", true, (index: string): Utils.Parameter => new Utils.TextParam(index, false)), new Utils.ListParam("file_categories", true, (index: string): Utils.Parameter => new Utils.UnionParam(index, false, [new Utils.VoidParam("image"), new Utils.VoidParam("document"), new Utils.VoidParam("pdf"), new Utils.VoidParam("spreadsheet"), new Utils.VoidParam("presentation"), new Utils.VoidParam("audio"), new Utils.VoidParam("video"), new Utils.VoidParam("folder"), new Utils.VoidParam("paper"), new Utils.VoidParam("others")])), new Utils.TextParam("account_id", true)]),
    ...
    const files_upload_session_finish_batch_v2_endpt = new Utils.Endpoint("files", "upload_session/finish_batch_v2",
        ...
        new Utils.ListParam("entries", false, (index: string): Utils.Parameter => new Utils.StructParam(index, false, [new Utils.StructParam("cursor", false, [new Utils.TextParam("session_id", false), new Utils.IntParam("offset", false)]), new Utils.StructParam("commit", false, [new Utils.TextParam("path", false), new Utils.UnionParam("mode", true, [new Utils.VoidParam("add"), new Utils.VoidParam("overwrite"), new Utils.TextParam("update", false)]), new Utils.BoolParam("autorename", true), new Utils.TextParam("client_modified", true), new Utils.BoolParam("mute", true), new Utils.ListParam("property_groups", true, (index: string): Utils.Parameter => new Utils.StructParam(index, false, [new Utils.TextParam("template_id", false), new Utils.ListParam("fields", false, (index: string): Utils.Parameter => new Utils.StructParam(index, false, [new Utils.TextParam("name", false), new Utils.TextParam("value", false)]))])), new Utils.BoolParam("strict_conflict", true)]), new Utils.TextParam("content_hash", true)]))
    );
    ...
    const files_upload_session_start_batch_endpt = new Utils.Endpoint("files", "upload_session/start_batch",
        {
            auth: "user",
            host: "api",
            style: "rpc",
        ...
        new Utils.IntParam("num_sessions", false),
        new Utils.UnionParam("session_type", true, [new Utils.VoidParam("sequential"), new Utils.VoidParam("concurrent")])
    );
    const openid_userinfo_endpt = new Utils.Endpoint("openid", "userinfo",
        {
            auth: "user",
            host: "api",
            style: "rpc",
    ...
    const riviera_get_ocr_async_endpt = new Utils.Endpoint("riviera", "get_ocr_async",
        {
            auth: "app, user",
            host: "api",
            style: "rpc",
    ...
    const riviera_get_ocr_async_check_endpt = new Utils.Endpoint("riviera", "get_ocr_async/check",
        {
            auth: "app, user",
            host: "api",
            style: "rpc",
    ...
    const riviera_get_transcript_async_endpt = new Utils.Endpoint("riviera", "get_transcript_async",
        ...
        new Utils.UnionParam("file_id_or_url", true, [new Utils.TextParam("file_id", false), new Utils.TextParam("url", false), new Utils.TextParam("path", false)]),
        new Utils.UnionParam("timestamp_level", true, [new Utils.VoidParam("sentence"), new Utils.VoidParam("word")]),
    ...
    const sharing_create_shared_link_with_settings_endpt = new Utils.Endpoint("sharing", "create_shared_link_with_settings",
        ...
        new Utils.TextParam("path", false),
        new Utils.StructParam("settings", true, [new Utils.BoolParam("require_password", true), new Utils.TextParam("link_password", true), new Utils.TextParam("expires", true), new Utils.UnionParam("audience", true, [new Utils.VoidParam("public"), new Utils.VoidParam("team"), new Utils.VoidParam("no_one"), new Utils.VoidParam("password"), new Utils.VoidParam("members")]), new Utils.UnionParam("access", true, [new Utils.VoidParam("viewer"), new Utils.VoidParam("editor"), new Utils.VoidParam("max"), new Utils.VoidParam("default")]), new Utils.UnionParam("requested_visibility", true, [new Utils.VoidParam("public"), new Utils.VoidParam("team_only"), new Utils.VoidParam("password")]), new Utils.BoolParam("allow_download", true)])
    );
    ...
    const sharing_modify_shared_link_settings_endpt = new Utils.Endpoint("sharing", "modify_shared_link_settings",
        ...
        new Utils.TextParam("url", false),
        new Utils.StructParam("settings", false, [new Utils.BoolParam("require_password", true), new Utils.TextParam("link_password", true), new Utils.TextParam("expires", true), new Utils.UnionParam("audience", true, [new Utils.VoidParam("public"), new Utils.VoidParam("team"), new Utils.VoidParam("no_one"), new Utils.VoidParam("password"), new Utils.VoidParam("members")]), new Utils.UnionParam("access", true, [new Utils.VoidParam("viewer"), new Utils.VoidParam("editor"), new Utils.VoidParam("max"), new Utils.VoidParam("default")]), new Utils.UnionParam("requested_visibility", true, [new Utils.VoidParam("public"), new Utils.VoidParam("team_only"), new Utils.VoidParam("password")]), new Utils.BoolParam("allow_download", true)]),
    ...
    const team_members_bulk_suspend_endpt = new Utils.Endpoint("team", "members/bulk_suspend",
        {
            auth: "team",
            host: "api",
            style: "rpc",
        ...
        new Utils.ListParam("members", false, (index: string): Utils.Parameter => new Utils.StructParam(index, false, [new Utils.TextParam("client_item_id", false), new Utils.StructParam("suspend_arg", false, [new Utils.UnionParam("user", false, [new Utils.TextParam("team_member_id", false), new Utils.TextParam("external_id", false), new Utils.TextParam("email", false)]), new Utils.BoolParam("wipe_data", true)])]))
    );
    const team_members_bulk_suspend_job_status_check_endpt = new Utils.Endpoint("team", "members/bulk_suspend/job_status/check",
        {
            auth: "team",
            host: "api",
            style: "rpc",
    ...
    const team_sharing_allowlist_add_endpt = new Utils.Endpoint("team", "sharing_allowlist/add",
        {
            auth: "team",
            host: "api",
            style: "rpc",
        ...
        new Utils.ListParam("domains", true, (index: string): Utils.Parameter => new Utils.TextParam(index, false)),
        new Utils.ListParam("emails", true, (index: string): Utils.Parameter => new Utils.TextParam(index, false))
    );
    const team_sharing_allowlist_list_endpt = new Utils.Endpoint("team", "sharing_allowlist/list",
        {
            auth: "team",
            host: "api",
            style: "rpc",
    ...
    const team_sharing_allowlist_list_continue_endpt = new Utils.Endpoint("team", "sharing_allowlist/list/continue",
        {
            auth: "team",
            host: "api",
            style: "rpc",
    ...
    const team_sharing_allowlist_remove_endpt = new Utils.Endpoint("team", "sharing_allowlist/remove",
        {
            auth: "team",
            host: "api",
            style: "rpc",
    ...
    export const endpointList: Utils.Endpoint[] = [account_delete_profile_photo_endpt,
                                                   ...
                                                   riviera_get_ocr_async_endpt,
                                                   riviera_get_ocr_async_check_endpt,
                                                   ...
                                                   team_sharing_allowlist_add_endpt,
                                                   team_sharing_allowlist_list_endpt,
                                                   team_sharing_allowlist_list_continue_endpt,
                                                   team_sharing_allowlist_remove_endpt,
