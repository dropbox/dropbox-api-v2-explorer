...
var Endpoints;
(function (Endpoints) {
    var account_set_profile_photo_endpt = new Utils.Endpoint("account", "set_profile_photo", {
    ...
    var check_app_endpt = new Utils.Endpoint("check", "app", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "True",
        select_admin_mode: "None",
    ...
    var check_user_endpt = new Utils.Endpoint("check", "user", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "True",
        select_admin_mode: "None",
    ...
    var contacts_delete_manual_contacts_endpt = new Utils.Endpoint("contacts", "delete_manual_contacts", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
    ...
    var contacts_delete_manual_contacts_batch_endpt = new Utils.Endpoint("contacts", "delete_manual_contacts_batch", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
        ...
        host: "api",
        scope: "contacts.write"
    }, new Utils.ListParam("email_addresses", false, function (index) { return new Utils.TextParam(index, false); }));
    ...
    }, new Utils.ListParam("queries", false, function (index) { return new Utils.StructParam(index, false, [new Utils.TextParam("query", false), new Utils.UnionParam("mode", false, [new Utils.TextParam("field_name", false)]), new Utils.UnionParam("logical_operator", true, [new Utils.VoidParam("or_operator")])]); }), new Utils.UnionParam("template_filter", true, [new Utils.ListParam("filter_some", false, function (index) { return new Utils.TextParam(index, false); }), new Utils.VoidParam("filter_none")]));
    ...
    }, new Utils.TextParam("name", false), new Utils.TextParam("description", false), new Utils.ListParam("fields", false, function (index) { return new Utils.StructParam(index, false, [new Utils.TextParam("name", false), new Utils.TextParam("description", false), new Utils.UnionParam("type", false, [new Utils.VoidParam("string")])]); }));
    ...
    var file_requests_count_endpt = new Utils.Endpoint("file_requests", "count", {
        allow_app_folder_app: "True",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
    ...
    var file_requests_delete_endpt = new Utils.Endpoint("file_requests", "delete", {
        allow_app_folder_app: "True",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
        ...
        host: "api",
        scope: "file_requests.write"
    }, new Utils.ListParam("ids", false, function (index) { return new Utils.TextParam(index, false); }));
    var file_requests_delete_all_closed_endpt = new Utils.Endpoint("file_requests", "delete_all_closed", {
        allow_app_folder_app: "True",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
    ...
    var file_requests_list_v2_endpt = new Utils.Endpoint("file_requests", "list_v2", {
        allow_app_folder_app: "True",
        is_cloud_doc_auth: "False",
        is_preview: "True",
        select_admin_mode: "None",
    ...
    var file_requests_list_continue_endpt = new Utils.Endpoint("file_requests", "list/continue", {
        allow_app_folder_app: "True",
        is_cloud_doc_auth: "False",
        is_preview: "True",
        select_admin_mode: "None",
    ...
    var files_copy_batch_v2_endpt = new Utils.Endpoint("files", "copy_batch_v2", {
        allow_app_folder_app: "True",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "team_admin",
        ...
        host: "api",
        scope: "files.content.write"
    }, new Utils.ListParam("entries", false, function (index) { return new Utils.StructParam(index, false, [new Utils.TextParam("from_path", false), new Utils.TextParam("to_path", false)]); }), new Utils.BoolParam("autorename", true));
    var files_copy_batch_check_v2_endpt = new Utils.Endpoint("files", "copy_batch/check_v2", {
        allow_app_folder_app: "True",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "team_admin",
    ...
    var files_export_endpt = new Utils.Endpoint("files", "export", {
        allow_app_folder_app: "True",
        is_cloud_doc_auth: "False",
        is_preview: "True",
        select_admin_mode: "whole_team",
    ...
    var files_get_file_lock_batch_endpt = new Utils.Endpoint("files", "get_file_lock_batch", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
    ...
    var files_get_metadata_endpt = new Utils.Endpoint("files", "get_metadata", {
        ...
        host: "api",
        scope: "files.metadata.read"
    }, new Utils.TextParam("path", false), new Utils.BoolParam("include_media_info", true), new Utils.BoolParam("include_deleted", true), new Utils.BoolParam("include_has_explicit_shared_members", true), new Utils.UnionParam("include_property_groups", true, [new Utils.ListParam("filter_some", false, function (index) { return new Utils.TextParam(index, false); })]));
    ...
    var files_get_temporary_upload_link_endpt = new Utils.Endpoint("files", "get_temporary_upload_link", {
        allow_app_folder_app: "True",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
        ...
        host: "api",
        scope: "files.content.write"
    }, new Utils.StructParam("commit_info", false, [new Utils.TextParam("path", false), new Utils.UnionParam("mode", true, [new Utils.VoidParam("add"), new Utils.VoidParam("overwrite"), new Utils.TextParam("update", false)]), new Utils.BoolParam("autorename", true), new Utils.TextParam("client_modified", true), new Utils.BoolParam("mute", true), new Utils.ListParam("property_groups", true, function (index) { return new Utils.StructParam(index, false, [new Utils.TextParam("template_id", false), new Utils.ListParam("fields", false, function (index) { return new Utils.StructParam(index, false, [new Utils.TextParam("name", false), new Utils.TextParam("value", false)]); })]); }), new Utils.BoolParam("strict_conflict", true)]), new Utils.FloatParam("duration", true));
    ...
    var files_get_thumbnail_v2_endpt = new Utils.Endpoint("files", "get_thumbnail_v2", {
        allow_app_folder_app: "True",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "whole_team",
        ...
        host: "content",
        scope: "files.content.read"
    }, new Utils.UnionParam("resource", false, [new Utils.TextParam("path", false), new Utils.StructParam("link", false, [new Utils.TextParam("url", false), new Utils.TextParam("path", true), new Utils.TextParam("password", true)])]), new Utils.UnionParam("format", true, [new Utils.VoidParam("jpeg"), new Utils.VoidParam("png")]), new Utils.UnionParam("size", true, [new Utils.VoidParam("w32h32"), new Utils.VoidParam("w64h64"), new Utils.VoidParam("w128h128"), new Utils.VoidParam("w256h256"), new Utils.VoidParam("w480h320"), new Utils.VoidParam("w640h480"), new Utils.VoidParam("w960h640"), new Utils.VoidParam("w1024h768"), new Utils.VoidParam("w2048h1536")]), new Utils.UnionParam("mode", true, [new Utils.VoidParam("strict"), new Utils.VoidParam("bestfit"), new Utils.VoidParam("fitone_bestfit")]));
    ...
    var files_list_folder_endpt = new Utils.Endpoint("files", "list_folder", {
        ...
        host: "api",
        scope: "files.metadata.read"
    }, new Utils.TextParam("path", false), new Utils.BoolParam("recursive", true), new Utils.BoolParam("include_media_info", true), new Utils.BoolParam("include_deleted", true), new Utils.BoolParam("include_has_explicit_shared_members", true), new Utils.BoolParam("include_mounted_folders", true), new Utils.IntParam("limit", true), new Utils.StructParam("shared_link", true, [new Utils.TextParam("url", false), new Utils.TextParam("password", true)]), new Utils.UnionParam("include_property_groups", true, [new Utils.ListParam("filter_some", false, function (index) { return new Utils.TextParam(index, false); })]), new Utils.BoolParam("include_non_downloadable_files", true));
    ...
    var files_lock_file_batch_endpt = new Utils.Endpoint("files", "lock_file_batch", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
    ...
    var files_move_batch_v2_endpt = new Utils.Endpoint("files", "move_batch_v2", {
        allow_app_folder_app: "True",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "team_admin",
        ...
        host: "api",
        scope: "files.content.write"
    }, new Utils.ListParam("entries", false, function (index) { return new Utils.StructParam(index, false, [new Utils.TextParam("from_path", false), new Utils.TextParam("to_path", false)]); }), new Utils.BoolParam("autorename", true), new Utils.BoolParam("allow_ownership_transfer", true));
    var files_move_batch_check_v2_endpt = new Utils.Endpoint("files", "move_batch/check_v2", {
        allow_app_folder_app: "True",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "team_admin",
    ...
    var files_search_v2_endpt = new Utils.Endpoint("files", "search_v2", {
        allow_app_folder_app: "True",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
        ...
        host: "api",
        scope: "files.metadata.read"
    }, new Utils.TextParam("query", false), new Utils.StructParam("options", true, [new Utils.TextParam("path", true), new Utils.IntParam("max_results", true), new Utils.UnionParam("file_status", true, [new Utils.VoidParam("active"), new Utils.VoidParam("deleted")]), new Utils.BoolParam("filename_only", true), new Utils.ListParam("file_extensions", true, function (index) { return new Utils.TextParam(index, false); }), new Utils.ListParam("file_categories", true, function (index) { return new Utils.UnionParam(index, false, [new Utils.VoidParam("image"), new Utils.VoidParam("document"), new Utils.VoidParam("pdf"), new Utils.VoidParam("spreadsheet"), new Utils.VoidParam("presentation"), new Utils.VoidParam("audio"), new Utils.VoidParam("video"), new Utils.VoidParam("folder"), new Utils.VoidParam("paper"), new Utils.VoidParam("others")]); })]), new Utils.BoolParam("include_highlights", true));
    var files_search_continue_v2_endpt = new Utils.Endpoint("files", "search/continue_v2", {
        allow_app_folder_app: "True",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
    ...
    var files_unlock_file_batch_endpt = new Utils.Endpoint("files", "unlock_file_batch", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "whole_team",
    ...
    var files_upload_session_finish_endpt = new Utils.Endpoint("files", "upload_session/finish", {
        ...
        host: "content",
        scope: "files.content.write"
    }, new Utils.FileParam(), new Utils.StructParam("cursor", false, [new Utils.TextParam("session_id", false), new Utils.IntParam("offset", false)]), new Utils.StructParam("commit", false, [new Utils.TextParam("path", false), new Utils.UnionParam("mode", true, [new Utils.VoidParam("add"), new Utils.VoidParam("overwrite"), new Utils.TextParam("update", false)]), new Utils.BoolParam("autorename", true), new Utils.TextParam("client_modified", true), new Utils.BoolParam("mute", true), new Utils.ListParam("property_groups", true, function (index) { return new Utils.StructParam(index, false, [new Utils.TextParam("template_id", false), new Utils.ListParam("fields", false, function (index) { return new Utils.StructParam(index, false, [new Utils.TextParam("name", false), new Utils.TextParam("value", false)]); })]); }), new Utils.BoolParam("strict_conflict", true)]));
    var files_upload_session_finish_batch_endpt = new Utils.Endpoint("files", "upload_session/finish_batch", {
        ...
        host: "api",
        scope: "files.content.write"
    }, new Utils.ListParam("entries", false, function (index) { return new Utils.StructParam(index, false, [new Utils.StructParam("cursor", false, [new Utils.TextParam("session_id", false), new Utils.IntParam("offset", false)]), new Utils.StructParam("commit", false, [new Utils.TextParam("path", false), new Utils.UnionParam("mode", true, [new Utils.VoidParam("add"), new Utils.VoidParam("overwrite"), new Utils.TextParam("update", false)]), new Utils.BoolParam("autorename", true), new Utils.TextParam("client_modified", true), new Utils.BoolParam("mute", true), new Utils.ListParam("property_groups", true, function (index) { return new Utils.StructParam(index, false, [new Utils.TextParam("template_id", false), new Utils.ListParam("fields", false, function (index) { return new Utils.StructParam(index, false, [new Utils.TextParam("name", false), new Utils.TextParam("value", false)]); })]); }), new Utils.BoolParam("strict_conflict", true)])]); }));
    ...
    var sharing_add_file_member_endpt = new Utils.Endpoint("sharing", "add_file_member", {
        ...
        host: "api",
        scope: "sharing.write"
    }, new Utils.TextParam("file", false), new Utils.ListParam("members", false, function (index) { return new Utils.UnionParam(index, false, [new Utils.TextParam("dropbox_id", false), new Utils.TextParam("email", false)]); }), new Utils.TextParam("custom_message", true), new Utils.BoolParam("quiet", true), new Utils.UnionParam("access_level", true, [new Utils.VoidParam("owner"), new Utils.VoidParam("editor"), new Utils.VoidParam("viewer"), new Utils.VoidParam("viewer_no_comment")]), new Utils.BoolParam("add_message_as_comment", true));
    ...
    var sharing_create_shared_link_with_settings_endpt = new Utils.Endpoint("sharing", "create_shared_link_with_settings", {
        ...
        host: "api",
        scope: "sharing.write"
    }, new Utils.TextParam("path", false), new Utils.StructParam("settings", true, [new Utils.UnionParam("requested_visibility", true, [new Utils.VoidParam("public"), new Utils.VoidParam("team_only"), new Utils.VoidParam("password")]), new Utils.TextParam("link_password", true), new Utils.TextParam("expires", true), new Utils.UnionParam("audience", true, [new Utils.VoidParam("public"), new Utils.VoidParam("team"), new Utils.VoidParam("no_one"), new Utils.VoidParam("password"), new Utils.VoidParam("members")]), new Utils.UnionParam("access", true, [new Utils.VoidParam("viewer"), new Utils.VoidParam("editor"), new Utils.VoidParam("max")])]));
    ...
    var sharing_list_file_members_endpt = new Utils.Endpoint("sharing", "list_file_members", {
        ...
        host: "api",
        scope: "sharing.read"
    }, new Utils.TextParam("file", false), new Utils.ListParam("actions", true, function (index) { return new Utils.UnionParam(index, false, [new Utils.VoidParam("leave_a_copy"), new Utils.VoidParam("make_editor"), new Utils.VoidParam("make_owner"), new Utils.VoidParam("make_viewer"), new Utils.VoidParam("make_viewer_no_comment"), new Utils.VoidParam("remove")]); }), new Utils.BoolParam("include_inherited", true), new Utils.IntParam("limit", true));
    ...
    var sharing_list_folder_members_endpt = new Utils.Endpoint("sharing", "list_folder_members", {
        ...
        host: "api",
        scope: "sharing.read"
    }, new Utils.TextParam("shared_folder_id", false), new Utils.ListParam("actions", true, function (index) { return new Utils.UnionParam(index, false, [new Utils.VoidParam("leave_a_copy"), new Utils.VoidParam("make_editor"), new Utils.VoidParam("make_owner"), new Utils.VoidParam("make_viewer"), new Utils.VoidParam("make_viewer_no_comment"), new Utils.VoidParam("remove")]); }), new Utils.IntParam("limit", true));
    ...
    var sharing_modify_shared_link_settings_endpt = new Utils.Endpoint("sharing", "modify_shared_link_settings", {
        ...
        host: "api",
        scope: "sharing.write"
    }, new Utils.TextParam("url", false), new Utils.StructParam("settings", false, [new Utils.UnionParam("requested_visibility", true, [new Utils.VoidParam("public"), new Utils.VoidParam("team_only"), new Utils.VoidParam("password")]), new Utils.TextParam("link_password", true), new Utils.TextParam("expires", true), new Utils.UnionParam("audience", true, [new Utils.VoidParam("public"), new Utils.VoidParam("team"), new Utils.VoidParam("no_one"), new Utils.VoidParam("password"), new Utils.VoidParam("members")]), new Utils.UnionParam("access", true, [new Utils.VoidParam("viewer"), new Utils.VoidParam("editor"), new Utils.VoidParam("max")])]), new Utils.BoolParam("remove_expiration", true));
    ...
    var sharing_remove_file_member_2_endpt = new Utils.Endpoint("sharing", "remove_file_member_2", {
        ...
        host: "api",
        scope: "sharing.write"
    }, new Utils.TextParam("file", false), new Utils.UnionParam("member", false, [new Utils.TextParam("dropbox_id", false), new Utils.TextParam("email", false)]));
    var sharing_remove_folder_member_endpt = new Utils.Endpoint("sharing", "remove_folder_member", {
        ...
        host: "api",
        scope: "sharing.write"
    }, new Utils.TextParam("shared_folder_id", false), new Utils.UnionParam("member", false, [new Utils.TextParam("dropbox_id", false), new Utils.TextParam("email", false)]), new Utils.BoolParam("leave_a_copy", false));
    ...
    var sharing_set_access_inheritance_endpt = new Utils.Endpoint("sharing", "set_access_inheritance", {
        ...
        host: "api",
        scope: "sharing.write"
    }, new Utils.TextParam("shared_folder_id", false), new Utils.UnionParam("access_inheritance", true, [new Utils.VoidParam("inherit"), new Utils.VoidParam("no_inherit")]));
    var sharing_share_folder_endpt = new Utils.Endpoint("sharing", "share_folder", {
        ...
        host: "api",
        scope: "sharing.write"
    }, new Utils.TextParam("path", false), new Utils.UnionParam("acl_update_policy", true, [new Utils.VoidParam("owner"), new Utils.VoidParam("editors")]), new Utils.BoolParam("force_async", true), new Utils.UnionParam("member_policy", true, [new Utils.VoidParam("team"), new Utils.VoidParam("anyone")]), new Utils.UnionParam("shared_link_policy", true, [new Utils.VoidParam("anyone"), new Utils.VoidParam("team"), new Utils.VoidParam("members")]), new Utils.UnionParam("viewer_info_policy", true, [new Utils.VoidParam("enabled"), new Utils.VoidParam("disabled")]), new Utils.UnionParam("access_inheritance", true, [new Utils.VoidParam("inherit"), new Utils.VoidParam("no_inherit")]), new Utils.ListParam("actions", true, function (index) { return new Utils.UnionParam(index, false, [new Utils.VoidParam("change_options"), new Utils.VoidParam("disable_viewer_info"), new Utils.VoidParam("edit_contents"), new Utils.VoidParam("enable_viewer_info"), new Utils.VoidParam("invite_editor"), new Utils.VoidParam("invite_viewer"), new Utils.VoidParam("invite_viewer_no_comment"), new Utils.VoidParam("relinquish_membership"), new Utils.VoidParam("unmount"), new Utils.VoidParam("unshare"), new Utils.VoidParam("leave_a_copy"), new Utils.VoidParam("share_link"), new Utils.VoidParam("create_link"), new Utils.VoidParam("set_access_inheritance")]); }), new Utils.StructParam("link_settings", true, [new Utils.UnionParam("access_level", true, [new Utils.VoidParam("owner"), new Utils.VoidParam("editor"), new Utils.VoidParam("viewer"), new Utils.VoidParam("viewer_no_comment")]), new Utils.UnionParam("audience", true, [new Utils.VoidParam("public"), new Utils.VoidParam("team"), new Utils.VoidParam("no_one"), new Utils.VoidParam("password"), new Utils.VoidParam("members")]), new Utils.UnionParam("expiry", true, [new Utils.VoidParam("remove_expiry"), new Utils.TextParam("set_expiry", false)]), new Utils.UnionParam("password", true, [new Utils.VoidParam("remove_password"), new Utils.TextParam("set_password", false)])]));
    ...
    var sharing_update_file_member_endpt = new Utils.Endpoint("sharing", "update_file_member", {
        ...
        host: "api",
        scope: "sharing.write"
    }, new Utils.TextParam("file", false), new Utils.UnionParam("member", false, [new Utils.TextParam("dropbox_id", false), new Utils.TextParam("email", false)]), new Utils.UnionParam("access_level", false, [new Utils.VoidParam("owner"), new Utils.VoidParam("editor"), new Utils.VoidParam("viewer"), new Utils.VoidParam("viewer_no_comment")]));
    var sharing_update_folder_member_endpt = new Utils.Endpoint("sharing", "update_folder_member", {
        ...
        host: "api",
        scope: "sharing.write"
    }, new Utils.TextParam("shared_folder_id", false), new Utils.UnionParam("member", false, [new Utils.TextParam("dropbox_id", false), new Utils.TextParam("email", false)]), new Utils.UnionParam("access_level", false, [new Utils.VoidParam("owner"), new Utils.VoidParam("editor"), new Utils.VoidParam("viewer"), new Utils.VoidParam("viewer_no_comment")]));
    var sharing_update_folder_policy_endpt = new Utils.Endpoint("sharing", "update_folder_policy", {
        ...
        host: "api",
        scope: "sharing.write"
    }, new Utils.TextParam("shared_folder_id", false), new Utils.UnionParam("member_policy", true, [new Utils.VoidParam("team"), new Utils.VoidParam("anyone")]), new Utils.UnionParam("acl_update_policy", true, [new Utils.VoidParam("owner"), new Utils.VoidParam("editors")]), new Utils.UnionParam("viewer_info_policy", true, [new Utils.VoidParam("enabled"), new Utils.VoidParam("disabled")]), new Utils.UnionParam("shared_link_policy", true, [new Utils.VoidParam("anyone"), new Utils.VoidParam("team"), new Utils.VoidParam("members")]), new Utils.StructParam("link_settings", true, [new Utils.UnionParam("access_level", true, [new Utils.VoidParam("owner"), new Utils.VoidParam("editor"), new Utils.VoidParam("viewer"), new Utils.VoidParam("viewer_no_comment")]), new Utils.UnionParam("audience", true, [new Utils.VoidParam("public"), new Utils.VoidParam("team"), new Utils.VoidParam("no_one"), new Utils.VoidParam("password"), new Utils.VoidParam("members")]), new Utils.UnionParam("expiry", true, [new Utils.VoidParam("remove_expiry"), new Utils.TextParam("set_expiry", false)]), new Utils.UnionParam("password", true, [new Utils.VoidParam("remove_password"), new Utils.TextParam("set_password", false)])]), new Utils.ListParam("actions", true, function (index) { return new Utils.UnionParam(index, false, [new Utils.VoidParam("change_options"), new Utils.VoidParam("disable_viewer_info"), new Utils.VoidParam("edit_contents"), new Utils.VoidParam("enable_viewer_info"), new Utils.VoidParam("invite_editor"), new Utils.VoidParam("invite_viewer"), new Utils.VoidParam("invite_viewer_no_comment"), new Utils.VoidParam("relinquish_membership"), new Utils.VoidParam("unmount"), new Utils.VoidParam("unshare"), new Utils.VoidParam("leave_a_copy"), new Utils.VoidParam("share_link"), new Utils.VoidParam("create_link"), new Utils.VoidParam("set_access_inheritance")]); }));
    ...
    }, new Utils.ListParam("features", false, function (index) { return new Utils.UnionParam(index, false, [new Utils.VoidParam("upload_api_rate_limit"), new Utils.VoidParam("has_team_shared_dropbox"), new Utils.VoidParam("has_team_file_events"), new Utils.VoidParam("has_team_selective_sync")]); }));
    ...
    var team_groups_create_endpt = new Utils.Endpoint("team", "groups/create", {
        ...
        host: "api",
        scope: "groups.write"
    }, new Utils.TextParam("group_name", false), new Utils.BoolParam("add_creator_as_owner", true), new Utils.TextParam("group_external_id", true), new Utils.UnionParam("group_management_type", true, [new Utils.VoidParam("user_managed"), new Utils.VoidParam("company_managed"), new Utils.VoidParam("system_managed")]));
    ...
    }, new Utils.TextParam("name", false), new Utils.ListParam("members", false, function (index) { return new Utils.TextParam(index, false); }), new Utils.TextParam("description", true), new Utils.TextParam("start_date", true), new Utils.TextParam("end_date", true));
    var team_legal_holds_get_policy_endpt = new Utils.Endpoint("team", "legal_holds/get_policy", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
    ...
    var team_legal_holds_list_held_revisions_endpt = new Utils.Endpoint("team", "legal_holds/list_held_revisions", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
    ...
    var team_legal_holds_list_held_revisions_continue_endpt = new Utils.Endpoint("team", "legal_holds/list_held_revisions_continue", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
    ...
    var team_legal_holds_list_policies_endpt = new Utils.Endpoint("team", "legal_holds/list_policies", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
    ...
    var team_legal_holds_release_policy_endpt = new Utils.Endpoint("team", "legal_holds/release_policy", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
    ...
    var team_legal_holds_update_policy_endpt = new Utils.Endpoint("team", "legal_holds/update_policy", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
        ...
        host: "api",
        scope: "team_data.member"
    }, new Utils.TextParam("id", false), new Utils.ListParam("members", false, function (index) { return new Utils.TextParam(index, false); }), new Utils.TextParam("name", true), new Utils.TextParam("description", true));
    ...
    var team_members_delete_profile_photo_endpt = new Utils.Endpoint("team", "members/delete_profile_photo", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
    ...
    var team_members_move_former_member_files_endpt = new Utils.Endpoint("team", "members/move_former_member_files", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
        ...
        host: "api",
        scope: "members.write"
    }, new Utils.UnionParam("user", false, [new Utils.TextParam("team_member_id", false), new Utils.TextParam("external_id", false), new Utils.TextParam("email", false)]), new Utils.UnionParam("transfer_dest_id", false, [new Utils.TextParam("team_member_id", false), new Utils.TextParam("external_id", false), new Utils.TextParam("email", false)]), new Utils.UnionParam("transfer_admin_id", false, [new Utils.TextParam("team_member_id", false), new Utils.TextParam("external_id", false), new Utils.TextParam("email", false)]));
    var team_members_move_former_member_files_job_status_check_endpt = new Utils.Endpoint("team", "members/move_former_member_files/job_status/check", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
    ...
    var team_members_secondary_emails_add_endpt = new Utils.Endpoint("team", "members/secondary_emails/add", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "True",
        select_admin_mode: "None",
        ...
        host: "api",
        scope: "members.write"
    }, new Utils.ListParam("new_secondary_emails", false, function (index) { return new Utils.StructParam(index, false, [new Utils.UnionParam("user", false, [new Utils.TextParam("team_member_id", false), new Utils.TextParam("external_id", false), new Utils.TextParam("email", false)]), new Utils.ListParam("secondary_emails", false, function (index) { return new Utils.TextParam(index, false); })]); }));
    var team_members_secondary_emails_delete_endpt = new Utils.Endpoint("team", "members/secondary_emails/delete", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "True",
        select_admin_mode: "None",
        ...
        host: "api",
        scope: "members.write"
    }, new Utils.ListParam("emails_to_delete", false, function (index) { return new Utils.StructParam(index, false, [new Utils.UnionParam("user", false, [new Utils.TextParam("team_member_id", false), new Utils.TextParam("external_id", false), new Utils.TextParam("email", false)]), new Utils.ListParam("secondary_emails", false, function (index) { return new Utils.TextParam(index, false); })]); }));
    var team_members_secondary_emails_resend_verification_emails_endpt = new Utils.Endpoint("team", "members/secondary_emails/resend_verification_emails", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "True",
        select_admin_mode: "None",
        ...
        host: "api",
        scope: "members.write"
    }, new Utils.ListParam("emails_to_resend", false, function (index) { return new Utils.StructParam(index, false, [new Utils.UnionParam("user", false, [new Utils.TextParam("team_member_id", false), new Utils.TextParam("external_id", false), new Utils.TextParam("email", false)]), new Utils.ListParam("secondary_emails", false, function (index) { return new Utils.TextParam(index, false); })]); }));
    ...
    var team_members_set_profile_photo_endpt = new Utils.Endpoint("team", "members/set_profile_photo", {
        allow_app_folder_app: "False",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
        ...
        host: "api",
        scope: "members.write"
    }, new Utils.UnionParam("user", false, [new Utils.TextParam("team_member_id", false), new Utils.TextParam("external_id", false), new Utils.TextParam("email", false)]), new Utils.UnionParam("photo", false, [new Utils.TextParam("base64_data", false)]));
    ...
    var team_team_folder_update_sync_settings_endpt = new Utils.Endpoint("team", "team_folder/update_sync_settings", {
        ...
        host: "api",
        scope: "team_data.team_space"
    }, new Utils.TextParam("team_folder_id", false), new Utils.UnionParam("sync_setting", true, [new Utils.VoidParam("default"), new Utils.VoidParam("not_synced")]), new Utils.ListParam("content_sync_settings", true, function (index) { return new Utils.StructParam(index, false, [new Utils.TextParam("id", false), new Utils.UnionParam("sync_setting", false, [new Utils.VoidParam("default"), new Utils.VoidParam("not_synced")])]); }));
    ...
    var team_log_get_events_endpt = new Utils.Endpoint("team_log", "get_events", {
        ...
        host: "api",
        scope: "events.read"
    }, new Utils.IntParam("limit", true), new Utils.TextParam("account_id", true), new Utils.StructParam("time", true, [new Utils.TextParam("start_time", true), new Utils.TextParam("end_time", true)]), new Utils.UnionParam("category", true, [new Utils.VoidParam("apps"), new Utils.VoidParam("comments"), new Utils.VoidParam("devices"), new Utils.VoidParam("domains"), new Utils.VoidParam("file_operations"), new Utils.VoidParam("file_requests"), new Utils.VoidParam("groups"), new Utils.VoidParam("legal_holds"), new Utils.VoidParam("logins"), new Utils.VoidParam("members"), new Utils.VoidParam("paper"), new Utils.VoidParam("passwords"), new Utils.VoidParam("reports"), new Utils.VoidParam("sharing"), new Utils.VoidParam("showcase"), new Utils.VoidParam("sso"), new Utils.VoidParam("team_folders"), new Utils.VoidParam("team_policies"), new Utils.VoidParam("team_profile"), new Utils.VoidParam("tfa"), new Utils.VoidParam("trusted_teams")]));
    ...
    var users_features_get_values_endpt = new Utils.Endpoint("users", "features/get_values", {
        allow_app_folder_app: "True",
        is_cloud_doc_auth: "False",
        is_preview: "False",
        select_admin_mode: "None",
    ...
    }, new Utils.ListParam("features", false, function (index) { return new Utils.UnionParam(index, false, [new Utils.VoidParam("paper_as_files"), new Utils.VoidParam("file_locking")]); }));
    ...
    Endpoints.endpointList = [account_set_profile_photo_endpt,
